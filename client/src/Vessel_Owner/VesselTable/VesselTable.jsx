...
const VesselTable = () => {
  ...
  useEffect(() => {
    const fetchShipDetails = async () => {
      try {
        const response = await fetch("https://bridgeviewships.ae:8000/api/vesselform");
            ...
            {shipDetails.map((ship, index) => (
              <tr key={index}>
                ...
                <td>
                  {ship.seaAgreement && (
                    <a
                      href={`https://bridgeviewships.ae:8000/${ship.seaAgreement.filePath}`}
                      target="_blank"
                  ...
                  {ship.cbaAgreement && (
                    <a
                      href={`https://bridgeviewships.ae:8000/${ship.cbaAgreement.filePath}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      CBA Agreement
                  ...
                  {ship.piDoc && (
                    <a
                      href={`https://bridgeviewships.ae:8000/${ship.piDoc.filePath}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      PI Document
                  ...
                  {ship.mlcCertDoc && (
                    <a
                      href={`https://bridgeviewships.ae:8000/${ship.mlcCertDoc.filePath}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      MLC Certificate
                  ...
                  {ship.financialDoc && (
                    <a
                      href={`https://bridgeviewships.ae:8000/${ship.financialDoc.filePath}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Financial Document
                  ...
                  {ship.dmlcPart1 && (
                    <a
                      href={`https://bridgeviewships.ae:8000/${ship.dmlcPart1.filePath}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      DMLC Part 1
                  ...
                  {ship.dmlcPart2 && (
                    <a
                      href={`https://bridgeviewships.ae:8000/${ship.dmlcPart2.filePath}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      DMLC Part 2
