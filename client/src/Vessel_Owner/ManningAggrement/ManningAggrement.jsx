...
const ManningAgrrement = () => {
  ...
  const handleAddToList = async () => {
    ...
    try {
      const response = await fetch("http://65.2.6.57:8000/api/manningAgreement", {
        method: "POST",
        body: formDataToSend,
      });
      ...
      if (response.ok) {
        ...
        fetch("http://65.2.6.57:8000/api/manningAgreement")
          .then((res) => res.json())
          .then((data) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://65.2.6.57:5000/api/manningAgreement", {
        method: "POST",
        body: formDataToSend,
      });
