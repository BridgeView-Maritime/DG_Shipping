...
const ShipDetailsDisplay = () => {
  ...
  useEffect(() => {
    ...
    const fetchShipDetails = async () => {
      try {
        const response = await fetch("http://3.109.202.136:8000/api/shipDetails");
          ...
          {shipDetails.map((ship, index) => (
            <tr key={index}>
              ...
              <td>
                {ship.seaAgreement && (
                  <a
                    href={`http://3.109.202.136:8000/${ship.seaAgreement.filePath}`}
                    target="_blank"
              ...
              <td>
                {ship.cbaAgreement && (
                  <a
                    href={`http://3.109.202.136:8000/${ship.cbaAgreement.filePath}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View CBA Agreement
                ...
                {ship.piDoc && (
                  <a
                    href={`http://3.109.202.136:8000/${ship.piDoc.filePath}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View PI Document
                ...
                {ship.mlcCertDoc && (
                  <a
                    href={`http://3.109.202.136:8000/${ship.mlcCertDoc.filePath}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                {ship.financialDoc && (
                  <a
                    href={`http://3.109.202.136:8000/${ship.financialDoc.filePath}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                {ship.dmlcPart1 && (
                  <a
                    href={`http://3.109.202.136:8000/${ship.dmlcPart1.filePath}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View DMLC Part 1
                ...
                {ship.dmlcPart2 && (
                  <a
                    href={`http://3.109.202.136:8000/${ship.dmlcPart2.filePath}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View DMLC Part 2
