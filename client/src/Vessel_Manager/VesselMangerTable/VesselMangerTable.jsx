...
const VesselManagerTable = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8000/api/vesselManager")
      .then((response) => {
        setVesselManagers(response.data);
  ...
  return (
    <>
      ...
      <div className="vesselMangerTable">
        <Link to="/VesselMangerForm">
          <button>Add Vessel Manager</button>
        </Link>
            ...
            {vesselManagers.map((manager) => (
              <tr key={manager._id}>
                ...
                <td>
                  ...
                  <strong>Person Name:</strong> {manager.crewingPersonName}{" "}
                  <br />
                  <strong>Phone Number:</strong> {manager.crewingPhoneNumber}{" "}
                  <br />
                ...
                <td>
                  ...
                  <strong>Person Name:</strong> {manager.accountsPersonName}{" "}
                  <br />
                  <strong>Phone Number:</strong> {manager.accountsPhoneNumber}{" "}
                  <br />
